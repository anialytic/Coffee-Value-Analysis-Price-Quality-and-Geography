...
PySpark: обробка великих даних та паралельних обчислень  
Jupiter Notebook: інтерактивний аналіз даних, експериментів  
KNNImputer: заповнення пропущених значень  
...
Потенційні проблеми: шифрувування, пропущені значення, аномальні викиди  


   ## 🧹 Підготовка даних     
Стандартизація назв країн, обсмажень і назв кав  
Перевірка пропусків і форматів цін  
Додавання похідних змінних: price_per_100g, origin_country, roaster_country   
📄 Код: price_per_100g.py, origin_country_standart.py, ML_price.ipynb  
🔍 Інструменти: Python (pandas),  KNNImputer  


   ## 📊 Описова статистика    

Середнє, медіана, мода (яка між ними різниця) Чи є натяк на перекошений розподіл?  
Стандартне відхилення / варіативність  Чи дані однорідні?  Чи є велика розбіжність?  
Мінімум/максимум  Чи є підозріло великі або негативні значення?   Чи розкид даних адекватний?  
Квартилі (Q1, Q3), IQR  Чи широкий інтерквартильний розмах?  Потенційні викиди?  
Для категоріальних змінних:  Розподіл частот (які категорії найпоширеніші)  Чи є домінуючі класи  
Кореляції (якщо ти їх включав у описову статистику)  Які ознаки мають помітну кореляцію?  Чи є багатоколінеарність?  
...
🔍 Інструменти: PostgreSQL, R  
   ...
   ## 🧠 Статистичний аналіз  
Виявлення ринкових закономірностей у галузі преміум-кави    
Формування цінової стратегії, визначення преміальних ринків та якості продукту залежно від характеристик обсмаження    
...
Подальший пост-хок тест (Тьюкі) виявив, що зразки з рівнем обсмаження Medium Light мають вищу середню оцінку, ніж Medium (p = 0.0077); інші порівняння не виявили суттєвих відмінностей  
       🔍 Інтерпретація для бізнесу:  
Каву з м’яким обсмаженням оцінено вище
...
Pie chart → топ-5 країн-виробників кави
...
спробувати виявити кореляцію


   ## Моделювання/Машинне навчання/Побудова моделей/Прогнозування / Класифікація / Регресія  
яку модель побудовано (наприклад, PyTorch NN, Random Forest, Logistic Regression тощо);  
що було таргетом;  
які метрики;  
ключові результати.  
☕ Лінійна регресія не підійшла ( чи треба писати про результати цього аналізу)  
...
☕Статистичний аналіз
які популярні та нестандартні функції додати?
🌱Візуалізація
